 ...
 <div class="row mb-3">
    <div class="col-lg-6">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="" name="key" autocomplete="off">
                  ...
                  <?php $no=1; ?> 
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url; ?>/User/formUbah/<?= $row['userId'];?>"><i class="fa fa-edit" style="color: blue;"></i></a>
                      </td>
                    </tr>
                    <?php $no++; endforeach; ?>
                  </tbody>
